...
namespace HiooshServer.Services
{
    public class ContactService : IContactsService
    {
        ...
        public ContactService()
        {
            ...
            contHadasForHail.last = "bye";
            contHadasForHail.lastdate = "05/24/2022 08:50 AM";
            ...
            contShiraForHail.last = "bye";
            contShiraForHail.lastdate = "05/24/2022 08:50 AM";
            Contact contHailForHadas = new Contact("Hail", "hailos", "localhost:5034");
            contHailForHadas.chat.Add(new Message(1, "hi", false, "05/24/2022 08:48 AM", "Text"));
            contHailForHadas.chat.Add(new Message(2, "bye", true, "05/24/2022 08:50 AM", "Text"));
            contHailForHadas.last = "bye";
            contHailForHadas.lastdate = "05/24/2022 08:50 AM";
            Contact contHailForShira = new Contact("Hail", "hailos", "localhost:5034");
            contHailForShira.chat.Add(new Message(1, "hi", false, "05/24/2022 08:48 AM", "Text"));
            contHailForShira.chat.Add(new Message(2, "bye", true, "05/24/2022 08:50 AM", "Text"));
            contHailForShira.lastdate = "05/24/2022 08:50 AM";
            contHailForShira.last = "bye";
